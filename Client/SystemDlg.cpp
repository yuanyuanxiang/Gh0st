...
//	m_tab.InsertItem(3, "拨号密码");
    m_tab.InsertItem(3, "软件");

    m_tab.InsertItem(4, "系统用户");
//	m_tab.InsertItem(5, "在线用户");
...
{
    // TODO: Add your command handler code here
//	OnMenuitemKillprocess(TRUE);
}

// void CSystemDlg::OnMenuitemKillprocess(BOOL bNeedDel = FALSE)
// {
// 	// TODO: Add your command handler code here
...
// 	if (m_list.GetSelectedCount() > 1)
// 	{
// 		str.Format("%s确实\n想终止%s这%d项进程吗?", lpTips, strText,m_list.GetSelectedCount());
// 	}
// 	else
// 	{
// 		str.Format("%s确实\n想终止%s该项进程吗?", lpTips,strText);
// 	}
...
void CSystemDlg::ShowSysInfoList()
{
    ...
    m_list.InsertColumn(1, "信息", LVCFMT_LEFT, 300);
    ...
    m_list.InsertItem(5, _T("当前用户"),4);
    m_list.InsertItem(6, _T("活动时间"),5);
    m_list.InsertItem(7, _T("安全软件"),6);
    m_list.InsertItem(8, _T("远程端口"),7);
    m_list.InsertItem(9, _T("是否双开"),8);
    m_list.InsertItem(10, _T("屏幕分辨率"),9);
//	m_list.InsertItem(11, _T("服务端位置"),10);
